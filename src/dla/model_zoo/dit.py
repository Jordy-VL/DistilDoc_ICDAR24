...
def build_dit_fpn_backbone(cfg, input_shape: ShapeSpec):
    """
...
def add_dit_defaults(cfg):
    # cfg.MODEL.VIT = CN() # Taken care of by ViT Det / DiT
    cfg.MODEL.VIT.ARCH = 'dit_base_patch16'
    cfg.MODEL.VIT.DROP_PATH = 0.1
    cfg.MODEL.VIT.IMG_SIZE = [224, 224]
